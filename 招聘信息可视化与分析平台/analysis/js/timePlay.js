...
TimePlay.prototype.initDate = function(){//初始化日期
	var timePlay = this;
	curr_date=new Date();
	var year  = parseInt(this.default_option['startDate']/10000);
	var month = parseInt((this.default_option['startDate']-year*10000)/100);
	var day = parseInt((this.default_option['startDate']-year*10000-month*100));
...
TimePlay.prototype.initDoms = function(){//初始化dom
	...
	var mainContainer = $('<div id="timeMain"></div>'),
	    ...
	    timeAxis = '<div class="timeProgress-box"><div class="hover-popup"></div><div class="curr-popup for-click">17:00</div><div class="timeProgress-hide"><div class="timeProgress-inner"><div class="timeProgress"><div class="timeProgress-bar"><div class="curr-popup for-animate">'+parseInt((this.default_option['startDate']+"")[4]+(this.default_option['startDate']+"")[5])+'月'+parseInt((this.default_option['startDate']+"")[6]+(this.default_option['startDate']+"")[7])+'日'+'</div></div></div><ul></ul></div></div></div>';
	...
	timePlay.timer = setInterval(function(){
		...
		if(timePlay.timeUnit == "时"){
			...
			if(timePlay.index < $(".every").length ){
				...
				all_source.clear();
				var time='2019-'+timePlay.curr_day.mon+'-'+timePlay.curr_day.day
